...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:veer-webapp-server.database.windows.net,1433;Database=veer-webapp-database;Uid=adminuser;Pwd=veeradmin@347;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
